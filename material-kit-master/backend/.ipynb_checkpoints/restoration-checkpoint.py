...
class Restoration:
    def __init__(self, seg_model_path="'/content/drive/My Drive/patch_detection.h5'",
    ...
    def get_segmented_image(self, img_path="/content/drive/My Drive/new_data/patched_imgs/patched_img1.png"):
    ...
    def give_result(self, unrestored_img_path, masked_img_path="temp_mask.jpg"):
        unrestored_img = plt.imread(unrestored_img_path)
        masked_img = self.get_segmented_image(unrestored_img_path)
